...
<body>
    ...
    <!-- <div class="pop-notice-sale">
        ...
        <div class="pns-thumb">
            <div class="image">
                <img loading="lazy" width="63" height="84" src="assets/images/product/product-4.jpg" alt="Image">
            </div>
            <div class="purchase">
        ...
        <div class="pns-content">
            ...
            <a href="/productdetails" class="fw-medium link mb-12 lh-24">
            ...
            <div class="bottom">
                ...
                <a href="/productdetails" class="tf-btn-line-2 style-primary">
                    ...
                    <div class="row">
                            ...
                            <div class="footer-col-block footer-wrap-1 mx-xl-auto">
                                ...
                                <div class="tf-collapse-content">
                                    <ul class="footer-menu-list">
                                        <li><a href="/about" class="cl-text-2 link">About Us</a></li>
                                        <li><a href="/contact" class="cl-text-2 link">Contact us</a></li>
                                        <li><a href="/blog" class="cl-text-2 link">Latest New</a></li>
                                        <li><a href="/account" class="cl-text-2 link">My Account</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-lg-2">
                            <div class="footer-col-block footer-wrap-2 mx-xl-auto">
                                ...
                                <div class="tf-collapse-content">
                                    <ul class="footer-menu-list">
                                        <li><a href="/shipping" class="cl-text-2 link">Shipping</a></li>
                                        <li><a href="/returnrefund" class="cl-text-2 link">Return & Refund</a>
                                        </li>
                                        <li><a href="/privacypolicy" class="cl-text-2 link">Privacy Policy</a></li>
                                        <li><a href="/termsandconditions" class="cl-text-2 link">Terms &
                                                Conditions</a></li>
                                        <li><a href="/faq" class="cl-text-2 link">Orders FAQs</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-col-block footer-wrap-3 mb-0">
                                ...
                                <div class="tf-collapse-content">
                                    ...
                                    <p class="text-remember cl-text-2">
                                        ...
                                        <a href="/termsandconditions" class="text-main link link-underline">
                                            Terms of Service
                                        </a>
                                        and
                                        <a href="/privacypolicy" class="text-main link link-underline">
                                            Privacy Policy
                                        </a>.
                                    </p>
                                </div>
                ...
                <div class="container">
                    <div class="tf-compare-list main-list-clear wrap-empty_text">
                        ...
                        <div class="tf-compare-buttons justify-content-center">
                            <a href="/compare" class="tf-btn animate-btn">Compare </a>
            ...
            <div class="modal-content">
                ...
                <div class="tf-product-quick_add tf-quick-prd_variant">
                    <div class="product-mini-view">
                        <a href="/productdetails" class="prd-image">
            ...
            <div class="canvas-body ps-md-0">
                <div class="tf-product-quick_view tf-quick-prd_variant">
                    ...
                    <div class="box-action">
                        <a href="/productdetails" class="tf-btn-line-2 style-primary fw-semibold">
                            View Full Details
                        </a>
                    </div>
                </div>
            ...
            <div class="wrap-recommendations">
                <div class="list-cart">
                    <div class="list-cart-item">
                        ...
                        <div class="content">
                            <a class="name fw-medium link text-line-clamp-1" href="/productdetails">
                                High neck midi wool coat
                            </a>
                            <div class="price-wrap">
                            ...
                            <div class="tf-mini-cart-items list-empty">
                                <div class="box-text_empty type-shop_cart">
                                    ...
                                    <div class="shop-empty_bot">
                                        ...
                                        <a href="/" class="tf-btn btn-stroke">Back to home </a>
                                    </div>
                                </div>
                                <div class="tf-mini-cart-item file-delete">
                                    ...
                                    <div class="tf-mini-cart-info">
                                        <a href="/productdetails" class="name fw-medium link text-line-clamp-1">
                        ...
                        <div class="tf-mini-cart-bottom-wrap">
                            ...
                            <div class="checkbox-wrap">
                                ...
                                <label for="agree-term">
                                    I agree with
                                    <a href="/termsandconditions" class="text-decoration-underline">
                                        Terms & Conditions
                                    </a>
                                </label>
                            </div>
                            <div class="tf-mini-cart-view-checkout">
                                <a href="/cart" class="tf-btn btn-stroke">
                                    View cart
                                </a>
                                <a href="/checkout" class="tf-btn animate-btn">
                                    Check Out
                                </a>
                            </div>
                            <a href="/shop"
